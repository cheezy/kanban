defmodule Kanban.Tasks do
  ...
  def update_task(%Task{} = task, attrs) do
    ...
    changeset = validate_circular_dependencies(changeset)
  ...
  Only performs the DB check when dependencies have changed and the task has an id.
  Scopes the check to the task's board to avoid false positives from
  duplicate identifiers on other boards.
  """
