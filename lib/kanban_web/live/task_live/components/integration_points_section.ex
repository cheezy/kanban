          ...
          <div>
            ...
            <ul class="list-disc list-inside space-y-1">
              <%= for event <- @integration_points["telemetry_events"] do %>
                <li class="text-[var(--stride-violet-ink)] font-mono text-xs">{event}</li>
              <% end %>
            </ul>
          </div>
        <% end %>
          ...
          <div>
            ...
            <ul class="list-disc list-inside space-y-1">
              <%= for broadcast <- @integration_points["pubsub_broadcasts"] do %>
                <li class="text-[var(--stride-violet-ink)] font-mono text-xs">{broadcast}</li>
              <% end %>
            </ul>
          </div>
        <% end %>
          ...
          <div>
            ...
            <ul class="list-disc list-inside space-y-1">
              <%= for channel <- @integration_points["phoenix_channels"] do %>
                <li class="text-[var(--stride-violet-ink)] font-mono text-xs">{channel}</li>
              <% end %>
            </ul>
          </div>
        <% end %>
          ...
          <div>
            ...
            <ul class="list-disc list-inside space-y-1">
              <%= for api <- @integration_points["external_apis"] do %>
                <li class="text-[var(--stride-violet-ink)] font-mono text-xs">{api}</li>
              <% end %>
            </ul>
          </div>
        <% end %>
